...
interface StitchingReadyEmailProps {
  orderNumber: string;
  customerName: string;
  garmentType: string;
}
...
export const StitchingReadyEmail = ({
  orderNumber = 'FB000000',
  customerName = 'Valued Customer',
  garmentType = 'Custom Garment',
}: StitchingReadyEmailProps) => {
  return (
    <Html>
      <Head />
      <Preview>Your {garmentType} is ready for dispatch!</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={contentSection}>
            <Text style={heading}>It's Ready, {customerName}!</Text>
            
            <Text style={paragraph}>
              Your <strong>{garmentType}</strong> has passed our strict Quality Control checks and is now packaged and ready for dispatch.
            </Text>
            ...
            <Text style={subheading}>Current Status: Ready</Text>
            ...
            <table style={{ width: '100%', margin: '20px 0', textAlign: 'center', fontSize: '14px' }}>
              <tbody>
                <tr>
                  ...
                  <td style={{ color: '#2ecc71', fontWeight: 'bold' }}>Stitched ✓</td>
                  <td style={{ color: '#bbb' }}>—</td>
                  <td style={{ color: '#2ecc71', fontWeight: 'bold' }}>QC ✓</td>
                  <td style={{ color: '#bbb' }}>—</td>
                  <td style={{ color: '#D4A853', fontWeight: 'bold', fontSize: '16px' }}>Ready ←</td>
                </tr>
              </tbody>
            </table>

            <Text style={paragraph}>
              We will send you another update with tracking information as soon as our delivery partner picks up your package.
            </Text>
...
export default StitchingReadyEmail;
