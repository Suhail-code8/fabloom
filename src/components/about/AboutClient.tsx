...
export default function AboutClient() {
    ...
    return (
        <div className="min-h-screen font-sans" style={{ backgroundColor: '#0f1035' }}>

            {/* 1. HERO SECTION */}
            <section className="relative text-white py-24 px-6 overflow-hidden flex flex-col items-center justify-center text-center" style={{ backgroundColor: '#07091c' }}>
                {/* Geometric pattern background */}
                <div
                    className="absolute inset-0 opacity-[0.06] pointer-events-none"
                    style={{
                        backgroundImage: 'linear-gradient(45deg, #D4A853 25%, transparent 25%, transparent 75%, #D4A853 75%, #D4A853), linear-gradient(45deg, #D4A853 25%, transparent 25%, transparent 75%, #D4A853 75%, #D4A853)',
                ...
                <div
                    ...
                    style={{ background: 'radial-gradient(ellipse at 50% 0%, rgba(212,168,83,0.15) 0%, transparent 70%)' }}
                />
                <div className="absolute top-0 left-0 right-0 h-px" style={{ background: 'linear-gradient(to right, transparent, rgba(212,168,83,0.5), transparent)' }} />
                ...
                <div className="relative z-10 max-w-2xl mx-auto">
                    <Image
                        ...
                        style={{ border: '2px solid #D4A853', boxShadow: '0 0 28px rgba(212,168,83,0.3)' }}
                    />
                    <h1
                        className="text-5xl md:text-6xl font-serif tracking-tight mb-6"
                        style={{ color: '#D4A853' }}
                    >
                        Fabloom Kandoras
                    </h1>
                    <p className="text-lg md:text-xl font-medium tracking-wide" style={{ color: 'rgba(255,255,255,0.6)' }}>
                        Premium Islamic Fashion · Delivered Across India
                    </p>
                </div>

                <div className="absolute bottom-0 left-0 right-0 h-px" style={{ background: 'linear-gradient(to right, transparent, rgba(212,168,83,0.5), transparent)' }} />
            </section>

            <div className="max-w-4xl mx-auto">
                {/* 2. OUR STORY */}
                <section className="py-16 px-6">
                    <div className="pl-6 max-w-2xl mx-auto" style={{ borderLeft: '3px solid #D4A853' }}>
                        <h2 className="text-xs font-extrabold uppercase tracking-widest mb-3" style={{ color: '#D4A853' }}>Our Story</h2>
                        <h3 className="text-2xl font-bold mb-6" style={{ color: 'rgba(255,255,255,0.95)' }}>
                            Born in Koduvally. <br/>Crafted for the modern wardrobe.
                        </h3>
                        <div className="space-y-4 text-sm leading-relaxed font-medium" style={{ color: 'rgba(255,255,255,0.55)' }}>
                            <p>
                ...
                {/* 3. WHY FABLOOM */}
                <section
                    className="py-16 px-6 rounded-3xl mx-4 md:mx-6 mb-16"
                    style={{
                ...
                >
                    <div className="text-center mb-10">
                        <h2 className="text-2xl font-bold" style={{ color: 'rgba(255,255,255,0.92)' }}>Why choose us?</h2>
                        <div className="w-10 h-1 mx-auto mt-4 rounded-full" style={{ backgroundColor: '#D4A853' }} />
                    </div>
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-y-10 gap-x-6">
                        {WHY_FEATURES.map((feature, idx) => (
                            <div key={idx} className="flex flex-col items-center text-center group">
                                ...
                                <h3 className="text-xs font-bold px-2" style={{ color: 'rgba(255,255,255,0.8)' }}>{feature.title}</h3>
                            </div>
                        ))}
                    </div>
                </section>
                ...
                <section className="py-16 px-6">
                    <div className="text-center mb-12">
                        <h2 className="text-2xl font-bold" style={{ color: 'rgba(255,255,255,0.92)' }}>How it works</h2>
                        <p className="text-sm mt-2 font-medium" style={{ color: 'rgba(255,255,255,0.4)' }}>From fabric to your doorstep.</p>
                    </div>

                    <div className="flex flex-col md:flex-row relative max-w-3xl mx-auto gap-8 md:gap-0">
                        {/* Connecting Line */}
                        <div
                            className="absolute top-0 bottom-0 left-[31px] md:left-0 md:right-0 md:top-[31px] md:bottom-auto md:h-0.5 w-0.5 md:w-full -z-10"
                            style={{ borderLeft: '2px dashed rgba(212,168,83,0.25)', borderTop: 'none' }}
                        />
                        <div
                            className="hidden md:block absolute md:left-0 md:right-0 md:top-[31px] md:h-0.5 md:w-full -z-10"
                            style={{ borderTop: '2px dashed rgba(212,168,83,0.25)' }}
                        />

                        {WORK_STEPS.map((step, idx) => (
                            <div key={idx} className="flex md:flex-col items-center md:flex-1 relative" style={{ backgroundColor: 'transparent' }}>
                                <div
                                    className="w-16 h-16 rounded-full flex items-center justify-center shadow-md flex-shrink-0 z-10"
                                    style={{
                                ...
                                <div className="ml-6 md:ml-0 md:mt-6 text-left md:text-center">
                                    <div className="flex items-center md:justify-center gap-2 mb-1" style={{ color: '#D4A853' }}>
                                        {step.icon}
                                        <h3 className="text-sm font-extrabold" style={{ color: 'rgba(255,255,255,0.9)' }}>{step.title}</h3>
                                    </div>
                                    <p className="text-xs font-medium md:max-w-[150px] mx-auto leading-snug" style={{ color: 'rgba(255,255,255,0.45)' }}>{step.desc}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <section className="py-16 px-0 overflow-hidden">
                    <div className="px-6 mb-8 flex items-end justify-between">
                        <div>
                            <h2 className="text-2xl font-bold" style={{ color: 'rgba(255,255,255,0.92)' }}>Loved by many</h2>
                            <div className="w-10 h-1 mt-4 rounded-full" style={{ backgroundColor: '#D4A853' }} />
                        </div>
                    </div>
                    ...
                    <div className="flex overflow-x-auto gap-4 px-6 pb-8 snap-x snap-mandatory no-scrollbar">
                        {TESTIMONIALS.map((test, idx) => (
                            <div
                                key={idx}
                                className="w-[85vw] md:w-[300px] flex-shrink-0 snap-center p-6 rounded-3xl"
                                style={{
                            ...
                            >
                                <div className="flex mb-4" style={{ color: '#D4A853' }}>
                                    {[1,2,3,4,5].map(star => (
                                ...
                                <p className="text-sm italic leading-relaxed mb-6" style={{ color: 'rgba(255,255,255,0.7)' }}>"{test.text}"</p>
                                <div>
                                    <h4 className="text-xs font-bold" style={{ color: 'rgba(255,255,255,0.9)' }}>{test.name}</h4>
                                    <p className="text-[10px] font-medium uppercase tracking-wider mt-1" style={{ color: 'rgba(255,255,255,0.4)' }}>{test.loc} · {test.type}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <section className="py-16 px-6">
                    <div className="text-center mb-10">
                        <h2 className="text-2xl font-bold" style={{ color: 'rgba(255,255,255,0.92)' }}>Frequently Asked Questions</h2>
                    </div>
                        ...
                        {FAQS.map((faq, idx) => {
                            ...
                            return (
                                <div
                                    ...
                                    style={{
                                        background: isOpen ? 'rgba(212,168,83,0.06)' : 'rgba(255,255,255,0.03)',
                                        border: isOpen ? '1px solid rgba(212,168,83,0.3)' : '1px solid rgba(255,255,255,0.08)',
                                ...
                                >
                                    ...
                                    >
                                        <span
                                            ...
                                            style={{ color: isOpen ? '#D4A853' : 'rgba(255,255,255,0.85)' }}
                                        >
                                            {faq.q}
                                        </span>
                                        <div
                                            className="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 ml-3 transition-transform duration-300"
                                            style={{
                                                transform: isOpen ? 'rotate(180deg)' : 'rotate(0deg)',
                                                backgroundColor: isOpen ? 'rgba(212,168,83,0.15)' : 'rgba(255,255,255,0.06)',
                                                color: isOpen ? '#D4A853' : 'rgba(255,255,255,0.4)',
                                            }}
                                        >
                                    ...
                                    >
                                        <div
                                            className="p-5 pt-0 text-sm leading-relaxed font-medium"
                                            style={{ color: 'rgba(255,255,255,0.5)', borderTop: '1px solid rgba(255,255,255,0.06)', marginTop: '4px' }}
                ...
                <section className="py-16 px-6 mb-10">
                    <div
                        ...
                        style={{
                            background: 'linear-gradient(135deg, #07091c 0%, #0f1035 60%, #1a1050 100%)',
                            border: '1px solid rgba(212,168,83,0.2)',
                            boxShadow: '0 0 60px rgba(212,168,83,0.08)',
                        }}
                    >
                        <div className="absolute top-0 right-0 w-64 h-64 rounded-full translate-x-20 -translate-y-20 blur-3xl pointer-events-none" style={{ backgroundColor: '#D4A853', opacity: 0.05 }} />

                        <h2 className="text-2xl font-serif mb-4" style={{ color: '#D4A853' }}>Still have questions?</h2>
                        <p className="text-sm mb-8 max-w-md mx-auto leading-relaxed" style={{ color: 'rgba(255,255,255,0.55)' }}>
                            Our support team is here to help you measure, track, or customize your order.
                        </p>

                        <a
                            href="https://wa.me/919544073317"
                            target="_blank" rel="noopener noreferrer"
                            className="inline-flex items-center justify-center gap-2 text-white font-bold text-sm px-8 py-4 rounded-full transition-transform active:scale-95 hover:brightness-110 shadow-lg w-full md:w-auto"
                            style={{ backgroundColor: '#25D366', boxShadow: '0 4px 24px rgba(37,211,102,0.25)' }}
                        >
                        ...
                        <div
                            className="mt-10 pt-8 flex flex-col md:flex-row justify-between text-xs gap-4 text-left"
                            style={{ borderTop: '1px solid rgba(255,255,255,0.08)', color: 'rgba(255,255,255,0.4)' }}
                        >
                            <div>
                                <p className="font-bold mb-1" style={{ color: 'rgba(255,255,255,0.85)' }}>Email Support</p>
                                <a href="mailto:support@fabloom.in" className="transition-colors hover:text-[#D4A853]">support@fabloom.in</a>
                            </div>
                            <div>
                                <p className="font-bold mb-1" style={{ color: 'rgba(255,255,255,0.85)' }}>Working Hours</p>
                                <p>Every day, 9:00 AM - 9:00 PM</p>
                            </div>
                            <div>
                                <p className="font-bold mb-1" style={{ color: 'rgba(255,255,255,0.85)' }}>Headquarters</p>
