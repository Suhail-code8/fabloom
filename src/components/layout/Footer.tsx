            ...
            <div className="flex flex-col gap-6 pt-8 pb-4 px-6 md:px-8 max-w-7xl mx-auto">
                ...
                <div className="flex flex-col items-center text-center pb-6" style={{ borderBottom: '1px solid rgba(212,168,83,0.15)' }}>
                    <Image
                        ...
                        width={40}
                        height={40}
                        className="rounded-full ring-1 ring-[#D4A853]/40 mb-3"
                    />
                    <h3 
                    ...
                    <div className="flex items-center gap-4">
                        <a href="https://www.instagram.com/fabloomkandoras/" target="_blank" rel="noreferrer" className="flex items-center justify-center w-10 h-10 rounded-lg border border-[#D4A853]/40 text-[#D4A853] hover:bg-[#D4A853]/10 transition-colors">
                            <Instagram className="w-5 h-5" />
                        </a>
                        <a href="https://www.facebook.com/profile.php?id=61584037474921" target="_blank" rel="noreferrer" className="flex items-center justify-center w-10 h-10 rounded-lg border border-[#D4A853]/40 text-[#D4A853] hover:bg-[#D4A853]/10 transition-colors">
                            <Facebook className="w-5 h-5" />
                        </a>
                        <a href="https://wa.me/919544073317" target="_blank" rel="noreferrer" className="flex items-center justify-center w-10 h-10 rounded-lg border border-[#D4A853]/40 text-[#D4A853] hover:bg-[#D4A853]/10 transition-colors">
