            ...
            <div className="flex flex-col gap-6 pt-8 pb-4 px-6 md:px-8 max-w-7xl mx-auto">
                ...
                <div className="flex flex-col items-center text-center pb-6" style={{ borderBottom: '1px solid rgba(212,168,83,0.15)' }}>
                    ...
                    <div className="flex items-center gap-4">
                        <a href="https://www.instagram.com/fabloomkandoras/" target="_blank" rel="noreferrer" className="flex items-center justify-center w-10 h-10 rounded-lg transition-all duration-300 hover:scale-110 hover:shadow-[0_0_16px_rgba(212,168,83,0.3)] hover:bg-[rgba(212,168,83,0.1)]" style={{ border: '1px solid rgba(212,168,83,0.3)', color: '#D4A853' }}>
                            <Instagram className="w-5 h-5" />
                        </a>
                        <a href="https://www.facebook.com/profile.php?id=61584037474921" target="_blank" rel="noreferrer" className="flex items-center justify-center w-10 h-10 rounded-lg transition-all duration-300 hover:scale-110 hover:shadow-[0_0_16px_rgba(212,168,83,0.3)] hover:bg-[rgba(212,168,83,0.1)]" style={{ border: '1px solid rgba(212,168,83,0.3)', color: '#D4A853' }}>
                            <Facebook className="w-5 h-5" />
                        </a>
                        <a href="https://wa.me/919544073317" target="_blank" rel="noreferrer" className="flex items-center justify-center w-10 h-10 rounded-lg transition-all duration-300 hover:scale-110 hover:shadow-[0_0_16px_rgba(212,168,83,0.3)] hover:bg-[rgba(212,168,83,0.1)]" style={{ border: '1px solid rgba(212,168,83,0.3)', color: '#D4A853' }}>
