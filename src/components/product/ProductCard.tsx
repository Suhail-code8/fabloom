            ...
            <CardFooter className="p-4 pt-0">
                {product.type === 'fabric' && product.stitchingAvailable ? (
                    <div className="w-full flex gap-2">
                        <Link href={`/${product.type === 'fabric' ? 'fabrics' : product.type === 'readymade' ? 'readymade' : 'accessories'}/${(product as any).slug ?? product._id}`} className="flex-1">
                            <Button
                                variant="outline"
                    ...
                    <Link href={`/${product.type === 'fabric' ? 'fabrics' : product.type === 'readymade' ? 'readymade' : 'accessories'}/${(product as any).slug ?? product._id}`} className="w-full">
